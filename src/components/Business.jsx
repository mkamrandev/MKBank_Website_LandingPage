...
const FeatureCard = ({icon, title, content,
  ...
  "mb-6" : "mb-0"} feature-card`}>
    ...
    <div className="flex-1 flex flex-col ml-3">
      ...
      text-white text-[18px] leaading-[23px] mb-1">
        {title}
      </h4>
      <p className="font-poppins font-normal 
      text-dimWhite text-[16px] leaading-[24px] mb-1">
        {content}
      </p>
    ...
    <section id="featues" className={layout.section}>
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} 
           max-w-[470px] mt-5`}>
          With the right creadit card, you can
          improve your financial life by building
          creadit, earning rewards and saving money.
          But with hundread of credit cards on the 
          market.
        </p>
